...
graph TD
    ...
    C --> D[Upload Dokumen]
    D --> E[Submit Aplikasi]
    E --> F[Review Dokumen oleh Tim PERPI]
    F --> G{Dokumen OK?}
    G -->|Revisi| D
    G -->|Disetujui| H[Kunjungan Kantor oleh Inspector PERPI]
    H --> I{Kantor Valid?}
    I -->|Tidak| J[Ditolak]
    I -->|Ya| K[Interview di kantor PERPI]
    K --> L[Rapat Pleno diinternal PERPI]
    L --> M{Keputusan}
